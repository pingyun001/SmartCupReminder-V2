...
static uint16_t ws2812RawBuf[24 * 4 + 1] = {0};
#define WS2812TL 		126
#define WS2812TS 		42
...
{
	WS2812_SetRGB(0, 0x0, 0x00, 0x01);
	WS2812_SetRGB(1, 0x0, 0x00, 0x02);
	WS2812_SetRGB(2, 0x0, 0x00, 0x03);
	WS2812_SetRGB(3, 0x0, 0x00, 0x04);
